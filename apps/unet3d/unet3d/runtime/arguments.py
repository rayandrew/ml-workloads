...
PARSER.add_argument(
    "--evaluate_every", "--eval_every", dest="evaluate_every", type=int, default=None
)
...
PARSER.add_argument(
    "--cudnn_benchmark", dest="cudnn_benchmark", action="store_true", default=False
)
PARSER.add_argument(
    "--cudnn_deterministic",
